...
{
    public sealed class NKC_Crypto
    {
      //  private NKEventEmitter events = NKEventEmitter.global;
        ...
        {
            return context.NKloadPlugin(typeof(NKC_Crypto), null, options);
        }

        private static string defaultNamespace { get { return "io.nodekit.platform.crypto"; } }
        ...
        public Byte[] getRandomBytesSync(Int32 blockSize)
        {
